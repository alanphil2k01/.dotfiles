...
bash_prompt() {
	...
	local PROMT_FORMAT=$YELLOW_BOLD
...
alias mnt3='sudo mount -o rw,exec,uid=1000,gid=1000 /dev/sda3 /mnt'
alias mnt4='sudo mount -o rw,exec,uid=1000,gid=1000 /dev/sda4 /mnt'
alias mnt4='sudo mount -o rw,exec,uid=1000,gid=1000 /dev/sda4 /mnt'
