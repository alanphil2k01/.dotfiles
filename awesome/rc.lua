...
globalkeys = my_table.join(
    -- Take a screenshot
    awful.key({ }, "Print", function() awful.util.spawn("flameshot gui -p /home/alan/Pictures/Screenshots") end,
              {description = "take a screenshot", group = "hotkeys"}),

    awful.key({ modkey, }, "Print", function() awful.util.spawn("flameshot full -p /home/alan/Pictures/Screenshots") end,
              {description = "take a screenshot of the whole screen", group = "hotkeys"}),

    -- X screen locker
    awful.key({  }, "XF86PowerOff", function () awful.util.spawn("lock && systemctl suspend") end, --NOTE set HandlePowerKey=ignore in /etc/systemd/logind.conf
