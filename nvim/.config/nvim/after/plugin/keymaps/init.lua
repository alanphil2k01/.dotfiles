...
-- Quickfix List
SetKeymap("n", "<C-j>", "<cmd>cnext<CR>", { noremap = true })
SetKeymap("n", "<C-k>", "<cmd>cprev<CR>", { noremap = true })

-- Go
SetKeymap("i", "<C-e>p", "if err != nil {<CR>panic(err.Error())<CR>}<CR>", { noremap = true })
SetKeymap("i", "<C-e>r", "if err != nil {<CR>return nil, err<CR>}<CR>", { noremap = true })
