...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/emmet-vim",
  ...
  gruvbox = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  neogit = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  playground = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/playground",
  ...
  undotree = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-monokai"] = {
    loaded = true,
    path = "/home/alan/.local/share/nvim/site/pack/packer/start/vim-monokai",
